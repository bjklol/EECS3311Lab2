...
extern void F985_7304(EIF_REFERENCE);
...
void F985_7304 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 984, Current, 0, 0, 13569);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(984, Current, 13569);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 984, Current, 0, 0, 13570);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(984, Current, 13570);
	RTIV(Current, RTAL);
	RTHOOK(1);
