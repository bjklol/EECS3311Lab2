...
extern EIF_TYPED_VALUE F964_7172(EIF_REFERENCE);
extern void F964_7804(EIF_REFERENCE, int);
...
RTOID (F964_7172)
EIF_TYPED_VALUE F964_7172 (EIF_REFERENCE Current)
{
	GTCX
...
void F964_7804 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 963, Current, 0, 7803);
	RTSA(dtype);
	RTME(dtype, 0);
