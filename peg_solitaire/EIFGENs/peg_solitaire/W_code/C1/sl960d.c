...
static const EIF_TYPE_INDEX egt_1_960 [] = {0xFF01,1016,959,0xFFFF};
...
static const struct desc_info desc_960[] = {
	...
	{EIF_GENERIC(egt_14_960), 13382, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_960), 13383, 0xFFFFFFFF},
	{EIF_GENERIC(egt_16_960), 13384, 0xFFFFFFFF},
};
void Init960(void)
{
	IDSC(desc_960, 0, 959);
