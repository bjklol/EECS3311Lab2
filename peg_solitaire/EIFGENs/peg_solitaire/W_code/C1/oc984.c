...
extern void F984_7302(EIF_REFERENCE);
extern EIF_TYPED_VALUE F984_7303(EIF_REFERENCE);
...
/* {OCCUPIED_SLOT}.make */
void F984_7302 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 983, Current, 0, 0, 13567);
	RTSA(Dtype(Current));
	RTSC;
...
/* {OCCUPIED_SLOT}.out */
EIF_TYPED_VALUE F984_7303 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 983, Current, 0, 0, 13568);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
