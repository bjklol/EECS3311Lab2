...
extern void F975_7285(EIF_REFERENCE);
...
void F975_7285 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 974, Current, 0, 0, 13550);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(974, Current, 13550);
	RTIV(Current, RTAL);
	RTHOOK(1);
	{
	...
	
	{
		...
		tr2 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A975_77, (EIF_POINTER)(0),5101, 0, 0, 1, -1, tr1, 0);
	}
	ur1 = RTCCL(tr2);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 974, Current, 1, 0, 13551);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(974, Current, 13551);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(3);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5200, "game", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(3,1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(4983, "make_easy", tr1))(tr1);
	RTHOOK(4);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(5202, "wins_easy_board", loc1))(loc1);
	RTHOOK(5);
