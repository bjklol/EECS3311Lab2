...
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5101, "test_good_player_wins_easy_board", closed [1].it_r))(closed [1].it_r);
}
...
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5104, "test_easy_game_creation", closed [1].it_r))(closed [1].it_r);
}

	/* STUDENT_TESTS test_number_of_occupied_slots */
EIF_TYPED_VALUE _A977_77 (EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5106, "test_number_of_occupied_slots", closed [1].it_r))(closed [1].it_r);
}

	/* STUDENT_TESTS test_out_feature */
EIF_TYPED_VALUE _A977_78 (EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	...
	/* STUDENT_TESTS test_good_player_wins_plus_board */
EIF_TYPED_VALUE _A977_79 (EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5108, "test_good_player_wins_plus_board", closed [1].it_r))(closed [1].it_r);
}

	/* STUDENT_TESTS test_good_player_wins_cross_board */
EIF_TYPED_VALUE _A977_80 (EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5109, "test_good_player_wins_cross_board", closed [1].it_r))(closed [1].it_r);
}
