...
extern void F993_7396(EIF_REFERENCE);
extern void F993_7397(EIF_REFERENCE);
extern void F993_7398(EIF_REFERENCE);
...
void F993_7396 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 992, Current, 1, 0, 13644);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(992, Current, 13644);
	RTIV(Current, RTAL);
...
void F993_7397 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 992, Current, 1, 0, 13645);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(992, Current, 13645);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTJB;
...
void F993_7398 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 992, Current, 1, 0, 13646);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(992, Current, 13646);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTJB;
