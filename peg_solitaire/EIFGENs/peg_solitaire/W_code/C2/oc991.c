...
extern void F991_7395(EIF_REFERENCE);
extern EIF_TYPED_VALUE F991_7396(EIF_REFERENCE);
...
/* {OCCUPIED_SLOT}.make */
void F991_7395 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 990, Current, 0, 0, 13643);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(990, Current, 13643);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
/* {OCCUPIED_SLOT}.out */
EIF_TYPED_VALUE F991_7396 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 990, Current, 0, 0, 13644);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(990, Current, 13644);
	RTIV(Current, RTAL);
	RTHOOK(1);
