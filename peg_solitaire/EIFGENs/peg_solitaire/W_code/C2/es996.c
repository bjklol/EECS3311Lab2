...
extern void F996_7416(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F996_7417(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F996_7416 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 995, Current, 0, 1, 13661);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F996_7417 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 995, Current, 0, 1, 13662);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F996_7418 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(5220,Dtype(Current)));
	return r;
}
