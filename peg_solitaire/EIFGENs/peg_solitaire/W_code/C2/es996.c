...
extern void F996_7416(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F996_7417(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F996_7418(EIF_REFERENCE);
...
void F996_7416 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 995, Current, 0, 2, 13661);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5217, 0xF80000FE, 0); /* case */
	RTAR(Current, arg2);
	...
	*(EIF_REFERENCE *)(Current + RTWA(5213, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTHOOK(3);
	RTDBGAA(Current, dtype, 5215, 0xF80000E7, 0); /* violation_tag */
	tr1 = RTMS_EX_H("",0,0);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(5215, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 5219, 0xF80000E7, 0); /* expected_tag_name */
...
void F996_7417 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 995, Current, 0, 3, 13662);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F996_7418 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 995, Current, 3, 0, 13663);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(995, Current, 13663);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	if ((EIF_BOOLEAN) !loc1) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 5211, 0x04000000, 1); /* passed */
	...
	if (tb1) {
		...
		*(EIF_BOOLEAN *)(Current + RTWA(5211, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
		...
		RTHOOK(7);
		RTDBGAA(Current, dtype, 5212, 0x04000000, 1); /* contract_violated */
		*(EIF_BOOLEAN *)(Current + RTWA(5212, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
		...
		RTAR(Current, tr1);
		*(EIF_REFERENCE *)(Current + RTWA(5215, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(10);
		RTDBGAA(Current, dtype, 5216, 0x10000000, 1); /* violation_type */
...
EIF_TYPED_VALUE F996_7419 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 995, Current, 0, 0, 13664);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(995, Current, 13664);
	RTIV(Current, RTAL);
	RTHOOK(1);
