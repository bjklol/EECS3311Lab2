...
extern void F992_7399(EIF_REFERENCE);
extern EIF_TYPED_VALUE F992_7400(EIF_REFERENCE);
...
/* {PLAYER}.make */
void F992_7399 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 991, Current, 1, 0, 13647);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(991, Current, 13647);
	RTIV(Current, RTAL);
	wstdinit(loc1,loc1);
	RTLXI(loc1);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5203, 0xF80003C1, 0); /* templates */
	...
	*(EIF_REFERENCE *)(Current + RTWA(5203, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 5202, 0xF80003C2, 0); /* game */
...
/* {PLAYER}.game */
EIF_TYPED_VALUE F992_7400 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
