...
extern void F997_7421(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F997_7422(EIF_REFERENCE);
extern EIF_TYPED_VALUE F997_7423(EIF_REFERENCE);
extern EIF_TYPED_VALUE F997_7424(EIF_REFERENCE);
...
void F997_7421 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 996, Current, 0, 2, 13666);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5217, 0xF8000125, 0); /* case */
	RTAR(Current, arg2);
...
void F997_7422 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 996, Current, 3, 0, 13667);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(996, Current, 13667);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	if ((EIF_BOOLEAN) !loc1) {
...
EIF_TYPED_VALUE F997_7423 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 996, Current, 0, 0, 13668);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(996, Current, 13668);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F997_7424 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
