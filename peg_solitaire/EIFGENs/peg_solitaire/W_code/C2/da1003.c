...
extern void F1003_7564(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1002, Current, 0, 1, 13810);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	RTHOOK(3);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5315, dtype))(Current, ur1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
EIF_TYPED_VALUE F1003_7561 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1002, Current, 0, 0, 13811);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1002, Current, 13811);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5322, Dtype(Current)));
	switch (ti4_1) {
		case 18L:
		case 19L:
		case 20L:
...
EIF_TYPED_VALUE F1003_7563 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(5314,Dtype(Current)));
	return r;
}


/* {DATE_TIME_CODE}.set_value */
void F1003_7564 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1002, Current, 1, 1, 13814);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 5316, 0xF80000E7, 0); /* value */
	...
	*(EIF_REFERENCE *)(Current + RTWA(5316, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5316, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	ur1 = RTCCL(tr1);
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5108, dtype))(Current, ur1x)).it_b);
	if (tb1) {
		RTHOOK(5);
		RTDBGAA(Current, dtype, 5317, 0x10000000, 1); /* count_max */
		*(EIF_INTEGER_32 *)(Current + RTWA(5317, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
		RTHOOK(6);
		RTDBGAA(Current, dtype, 5318, 0x10000000, 1); /* count_min */
		*(EIF_INTEGER_32 *)(Current + RTWA(5318, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
		...
		RTHOOK(8);
		RTDBGAA(Current, dtype, 5320, 0x10000000, 1); /* value_max */
		*(EIF_INTEGER_32 *)(Current + RTWA(5320, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 31L);
		RTHOOK(9);
		RTDBGAA(Current, dtype, 5321, 0x10000000, 1); /* value_min */
		*(EIF_INTEGER_32 *)(Current + RTWA(5321, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
		RTHOOK(10);
		RTDBGAA(Current, dtype, 5313, 0x04000000, 1); /* is_text */
		*(EIF_BOOLEAN *)(Current + RTWA(5313, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
		RTHOOK(11);
		RTDBGAA(Current, dtype, 5314, 0x04000000, 1); /* is_numeric */
		*(EIF_BOOLEAN *)(Current + RTWA(5314, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
		RTHOOK(12);
		RTDBGAA(Current, dtype, 5322, 0x10000000, 1); /* type */
		...
		*(EIF_INTEGER_32 *)(Current + RTWA(5322, dtype)) = (EIF_INTEGER_32) ti4_1;
		...
		if (tb1) {
			...
			*(EIF_INTEGER_32 *)(Current + RTWA(5317, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
			RTHOOK(15);
			RTDBGAA(Current, dtype, 5318, 0x10000000, 1); /* count_min */
			*(EIF_INTEGER_32 *)(Current + RTWA(5318, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
			RTHOOK(16);
			RTDBGAL(Current, 1, 0xF80000E7, 0, 0); /* loc1 */
			...
			*(EIF_INTEGER_32 *)(Current + RTWA(5322, dtype)) = (EIF_INTEGER_32) ti4_1;
			...
			if (tb1) {
				RTHOOK(23);
				RTDBGAA(Current, dtype, 5317, 0x10000000, 1); /* count_max */
				*(EIF_INTEGER_32 *)(Current + RTWA(5317, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
				RTHOOK(24);
				RTDBGAA(Current, dtype, 5318, 0x10000000, 1); /* count_min */
				*(EIF_INTEGER_32 *)(Current + RTWA(5318, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
				RTHOOK(25);
				RTDBGAL(Current, 1, 0xF80000E7, 0, 0); /* loc1 */
				loc1 = RTMS_EX_H("day-text",8,1643751284);
				RTHOOK(26);
				RTDBGAA(Current, dtype, 5320, 0x10000000, 1); /* value_max */
				*(EIF_INTEGER_32 *)(Current + RTWA(5320, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 7L);
				RTHOOK(27);
				RTDBGAA(Current, dtype, 5321, 0x10000000, 1); /* value_min */
				*(EIF_INTEGER_32 *)(Current + RTWA(5321, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
				RTHOOK(28);
				...
				*(EIF_BOOLEAN *)(Current + RTWA(5313, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
				RTHOOK(29);
				RTDBGAA(Current, dtype, 5314, 0x04000000, 1); /* is_numeric */
				*(EIF_BOOLEAN *)(Current + RTWA(5314, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
				RTHOOK(30);
				RTDBGAA(Current, dtype, 5322, 0x10000000, 1); /* type */
				...
				*(EIF_INTEGER_32 *)(Current + RTWA(5322, dtype)) = (EIF_INTEGER_32) ti4_1;
				...
				if (tb1) {
					RTHOOK(32);
					RTDBGAA(Current, dtype, 5317, 0x10000000, 1); /* count_max */
					*(EIF_INTEGER_32 *)(Current + RTWA(5317, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 4L);
					RTHOOK(33);
					RTDBGAA(Current, dtype, 5318, 0x10000000, 1); /* count_min */
					*(EIF_INTEGER_32 *)(Current + RTWA(5318, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 4L);
					RTHOOK(34);
					RTDBGAL(Current, 1, 0xF80000E7, 0, 0); /* loc1 */
						...
						*(EIF_INTEGER_32 *)(Current + RTWA(5321, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) -1L);
						...
						if (tb1) {
							...
							*(EIF_INTEGER_32 *)(Current + RTWA(5318, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
							...
							RTHOOK(53);
							RTDBGAA(Current, dtype, 5320, 0x10000000, 1); /* value_max */
							*(EIF_INTEGER_32 *)(Current + RTWA(5320, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 12L);
							RTHOOK(54);
							RTDBGAA(Current, dtype, 5321, 0x10000000, 1); /* value_min */
							*(EIF_INTEGER_32 *)(Current + RTWA(5321, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
							RTHOOK(55);
									...
									*(EIF_INTEGER_32 *)(Current + RTWA(5322, dtype)) = (EIF_INTEGER_32) ti4_1;
									...
									if (tb1) {
										...
										*(EIF_INTEGER_32 *)(Current + RTWA(5318, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
										...
										RTHOOK(80);
										RTDBGAA(Current, dtype, 5320, 0x10000000, 1); /* value_max */
										*(EIF_INTEGER_32 *)(Current + RTWA(5320, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 24L);
										RTHOOK(81);
										RTDBGAA(Current, dtype, 5321, 0x10000000, 1); /* value_min */
										*(EIF_INTEGER_32 *)(Current + RTWA(5321, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
										RTHOOK(82);
										RTDBGAA(Current, dtype, 5313, 0x04000000, 1); /* is_text */
										*(EIF_BOOLEAN *)(Current + RTWA(5313, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
										RTHOOK(83);
												...
												*(EIF_INTEGER_32 *)(Current + RTWA(5322, dtype)) = (EIF_INTEGER_32) ti4_1;
												...
												if (tb1) {
													...
													*(EIF_INTEGER_32 *)(Current + RTWA(5318, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
													...
													RTHOOK(107);
													RTDBGAA(Current, dtype, 5320, 0x10000000, 1); /* value_max */
													*(EIF_INTEGER_32 *)(Current + RTWA(5320, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 59L);
													RTHOOK(108);
													RTDBGAA(Current, dtype, 5321, 0x10000000, 1); /* value_min */
													*(EIF_INTEGER_32 *)(Current + RTWA(5321, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
													RTHOOK(109);
															...
															if (tb1) {
																...
																*(EIF_INTEGER_32 *)(Current + RTWA(5322, dtype)) = (EIF_INTEGER_32) ti4_1;
																...
																if (tb1) {
																	...
																	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5316, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
																	RTNHOOK(140,2);
	...
	RTHOOK(206);
	RTDBGAA(Current, dtype, 5319, 0xF80000E7, 0); /* name */
	RTAR(Current, loc1);
	*(EIF_REFERENCE *)(Current + RTWA(5319, dtype)) = (EIF_REFERENCE) RTCCL(loc1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(207);
		RTCT("value_set", EX_POST);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5316, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1002, Current, 0, 0, 13822);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
